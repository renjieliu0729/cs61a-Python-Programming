...
def make_averaged(original_function, total_samples=1000):
    ...
    def new_function(*argus):
        total = 0
        for i in range(0,total_samples) :
            total = total + original_function(*argus)
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    score_with_square = square_update(0, score, opponent_score, dice=six_sided)
    if score_with_square - score >= threshold :
        return 0
    else:
